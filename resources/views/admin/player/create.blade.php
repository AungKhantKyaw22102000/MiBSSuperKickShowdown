        ...
        <div class="container"><br>
            ...
            <form action="{{ route('admin#playerCreate') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    @enderror
                    <input class="form-control @error('playerName') is-invalid @enderror" type="text" name="playerName" value="{{ old("playerName") }}">
                </div>
                <div class="form-group">
                    ...
                    @enderror
                    <input class="form-control @error('backNumber') is-invalid @enderror" type="text" name="backNumber" value="{{ old("backNumber") }}">
                </div>
                <div class="form-group">
